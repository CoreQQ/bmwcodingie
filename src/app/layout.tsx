...
var chunkFail=function(m){return m&&/Loading chunk [^ ]+ failed|ChunkLoadError|Failed to fetch dynamically imported module|parallelRoutes|\\.children'\\)/i.test(String(m));};
