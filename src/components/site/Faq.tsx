...
const FAQS = [
  ...
  },
  {
    ...
    a: 'F, G and U-series across NBT, NBT Evo and MGU (iDrive 6/7/8) head units. Send me your model, year and VIN-derived build and I will confirm exactly what is possible on your car.',
  },
  {
