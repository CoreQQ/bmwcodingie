...
export const DEFAULT_CATALOG: CategoryWithServices[] = [
  {
    ...
    translations: {},
    services: [
      svc(1, 1, 'Apple CarPlay activation', 'Wired or full wireless CarPlay enabled on NBT Evo and MGU head units.', '€170 NBT Evo · €200 MGU'),
  ...
  },
  {
    ...
    translations: {},
    services: [
      svc(14, 4, 'Japan → EU conversion', 'Region change, radio bands, navigation FSC, EU maps and ETC handling for JDM imports.', '€280 NBT Evo · €330 MGU — CarPlay included'),
