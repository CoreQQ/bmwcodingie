...
export const DEFAULT_SETTINGS: SiteSettings = {
  ...
  about_text:
    'Independent BMW coding specialist working out of Dublin. ISTA/Rheingold, E-Sys and BimmerCode across F, G and E-series — done at your door, paid on completion.',
  service_area:
