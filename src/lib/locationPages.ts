  ...
  return {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: 'On most NBT Evo and MGU systems, yes — including wireless CarPlay where supported. Send your model, year and VIN-derived build and we confirm before you book. Activation is €170 on NBT Evo and €200 on MGU.',
      },
      {
