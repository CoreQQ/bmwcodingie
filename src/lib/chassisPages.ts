  ...
  return {
    ...
    faqs: [
      f.faq,
      {
        ...
        a: 'It depends on the features: CarPlay activation is €170 on NBT Evo and €200 on MGU, diagnostics start from €80, and multi-feature sessions are priced as a bundle. We confirm the price up front from your build.',
      },
      {
